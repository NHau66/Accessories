            ...
            <div class="row-admin">
                <ul class="pro-list">
                    <li class="pro-title">
                        ...
                        <div class="title-price_current">Số lượng</div>
    ...
    <div class="modalAdd js-modalAdd">
        <div class="modal-line">
            <div class="modalAdd-contain js-modalAdd-contain">
				...
				<form id = "_formData" method="POST" enctype="multipart/form-data">
						...
						<ul class="modalAdd-list">
							...
							<li class="modalAdd-item">
								...
								<div class="input_file">
									<input type="file" class="modalAdd-input_file" name="image_add1" >
									<input type="file" class="modalAdd-input_file" name="image_add2">
									<input type="file" class="modalAdd-input_file" name="image_add3">
									<input type="file" class="modalAdd-input_file" name="image_add4">
							...
							<li class="modalAdd-item">
								<span class="modalAdd-title" >Số lượng:</span>
								<input type="text" class="modalAdd-input" >
							</li>
						</ul>
                ...
                <div class="modalAdd-btn">
                    <button type="submit" id="upload" class="btn btn-save js-btn-save">Thêm</button>
    ...
    <div class="modalAdd js-modalEdit">
        <div class="modal-line">
            <div class="modalAdd-contain js-modalEdit-contain">
				...
				<form id = "_FormUpdate" method="POST" enctype="multipart/form-data">
                <div class="divflex" style="display: flex;">
                    <ul class="modalAdd-list">
                        <li class="modalAdd-item">
                            <span class="modalAdd-title">Tên sản phẩm:</span>
                        ...
                        <li class="modalAdd-item">
                            ...
                            <div class="input_file">
                                ...
                                <input type="file" class="modalAdd-input_file" name="image_edit1">
                                <input type="file" class="modalAdd-input_file" name="image_edit2">
                                <input type="file" class="modalAdd-input_file" name="image_edit3">
                                <input type="file" class="modalAdd-input_file" name="image_edit4">
	...
	<!-- load loại sản phẩm -->
	  <script>
		...
		function _ChangeType() {
			...
			if (selectedValue !="")
				document.location.href = "./adminProductList.php?loai=" + selectedValue;
			else
				document.location.href = "./adminProductList.php";
		}
	  ...
	  <script>
			$(document).ready(function()
			{
				$("#upload").click(function (event) {
					...
					var tenSP = document.getElementsByClassName("modalAdd-input")[0].value;
					var gia = document.getElementsByClassName("modalAdd-input")[1].value;
					var GiamGia = document.getElementsByClassName("modalAdd-input")[2].value ;
					
					var LoaiSP = document.getElementsByClassName("modalAdd-opt")[0].selectedOptions[0].className;		
					var SoLuong = document.getElementsByClassName("modalAdd-input")[3].value;		
					
					var ThongSoKiThuat = document.getElementsByClassName("modalAdd-input-descript")[0].value;
					var DacDiemNoiBat = document.getElementsByClassName("modalAdd-input-descript")[1].value;
					...
					for (var i = 0; i <4; i++)
					{
						var img = $(".modalAdd-input_file")[i].files[0];
						if (img != null)
							_files.push(img);
						...
						data.append("ThongSoKiThuat", ThongSoKiThuat);
						data.append("DacDiemNoiBat", DacDiemNoiBat);
						data.append("img1", _files);
	  ...
	  <script>
			function UpdateProduct(idSP)
			{
				...
				var SoLuong = document.getElementsByClassName("modalAdd-input")[7].value;		
				...
				// Get form
				var form = $('#_FormUpdate')[0];
		 
				// FormData object 
				var data = new FormData(form);
				
				// If you want to add an extra field for the FormData
				data.append("IDSanPham", idSP);
				data.append("tenSP", tenSP);
				data.append("gia", gia);
				data.append("GiamGia", GiamGia);
				data.append("LoaiSP", LoaiSP);
				...
				data.append("ThongSoKiThuat", ThongSoKiThuat);
				data.append("DacDiemNoiBat", DacDiemNoiBat);
				data.append("img_update", img_update);
	  ...
	  <script>
		...
		?>
				...
				var SoLuong = <?php echo $row["SoLuong"]; ?>;
				LoadData(id, img, name, OldPrice, SoLuong,giamGia)
		...
		function LoadData(id, img, name, OldPrice, FinalPrice,giamGia)
			{
				var item =  '<li class="pro-item">'+
							...
							'<div class="item-price_current">'+SoLuong+' cái</div>'+
							'<div class="item-descript">'+
		...
		function GetDataToEdit(idSP)
		{
			...
			$.ajax({
                    ...
                    success : function (result){
						...
						document.getElementsByClassName("modalAdd-input")[7].value = _GetData[8];
